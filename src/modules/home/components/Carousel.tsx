  ...
  return (
    <div>
      <div className="relative -mt-[var(--app-home-header-height)] mb-7 px-0 pt-[var(--app-home-header-height)] md:mb-9 md:px-8 min-[1024px]:mb-10 xxl:px-16">
        ...
        >
          <div
            className="absolute inset-0 z-10 backdrop-blur-[60px]"
            style={{
              background:
                theme === 'dark'
                  ? 'linear-gradient(0deg, rgb(20, 20, 20), rgba(0, 0, 0, 0)) rgba(0, 0, 0, 0.6)'
                  : 'linear-gradient(0deg, rgb(255, 255, 255), rgba(0, 0, 0, 0)) rgba(0, 0, 0, 0.6)',
            }}
          ></div>
        </div>
        <div className="relative mt-0 cursor-pointer md:mt-6 xxl:mt-8">
          {isFetching ? (
            <Skeleton.Node
              active={true}
              className="relative z-[200] h-[50vw] w-full md:rounded-xl min-[1024px]:h-[40vw] xxxl:h-[35vw]"
            />
          ) : data ? (
            <>
              ...
              >
                {data?.content.map((book) => (
                  ...
                  >
                    <div className="relative h-[50vw] before:absolute before:z-[2] before:h-full before:w-full before:bg-[rgba(0,0,0,0.35)] min-[1024px]:h-[40vw] xxxl:h-[35vw]">
