...
export default function BookItemHome({ bookItem }: BookItemProps) {
  ...
  const handlePopoverHover = () => {
    if (triggerRef.current) {
      ...
      const width = triggerWidth + triggerWidth * 0.34
        ...
        <div className="relative flex h-[258px] w-full px-2 max-[1679px]:h-[220px] max-[767px]:hidden">
          <div className="w-full">
            ...
            <div className="flex flex-col">
              ...
              <div className="xxxl:mt-2 xxxl:h-6 mt-[6px] h-[22px] overflow-hidden">
                {bookItem.category_book.map((category) => (
                  <Tag
                    ...
                    bordered={false}
                    className="xxxl:text-[13px] bg-[rgba(0,0,0,0.08)] text-[11px]"
                  >
              ...
              <div className="xxxl:bottom-4 absolute bottom-3 right-0 flex w-full items-center justify-end px-2 text-primary hover:text-primary/75">
